...
# TestImportBase/TestImportData used to be defined here, but they're pure
# pwem (ProtImportVolumes/ProtImportPdb) with no Chimera/Coot/Refmac/Phenix
# dependency - moved to pwem/tests/protocols/test_import_volume_and_pdb.py
# so that part gets collected (and cleanly skipped until the
# 'model_building_tutorial' dataset is synced) instead of being silently
# excluded along with the rest of this plugin-dependent file.
from pwem.tests.protocols.test_import_volume_and_pdb import (
    TestImportBase, TestImportData,
)
